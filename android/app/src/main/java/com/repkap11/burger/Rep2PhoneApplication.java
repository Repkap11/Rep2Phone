...
public class Rep2PhoneApplication extends Application {
    ...
    public static String getUserPerferedLunchGroup(Context context) {
        SharedPreferences prefs = context.getSharedPreferences(Rep2PhoneApplication.BURGER_PREF_GROUP, Context.MODE_PRIVATE);
        String pref = prefs.getString(Rep2PhoneApplication.BURGER_USER_GROUP_PREF, null);
        return pref;
    }
    ...
    public static void setUserPerferedLunchGroup(Context context, String value) {
        ...
        editor.putString(Rep2PhoneApplication.BURGER_USER_GROUP_PREF, value);
        editor.apply();
    }
