...
import com.repkap11.rep2phone.activities.AddLunchGroupFractivity;
import com.repkap11.rep2phone.activities.base.FirebaseAdapterFractivity;
import com.repkap11.rep2phone.activities.TabFractivity;
...
public class LunchGroupsFractivityFragment extends FirebaseAdapterFractivity.FirebaseAdapterFragment {
    ...
    protected void onItemClicked(View view, Object holderObject, int position, String key, String link, Object value) {
        ...
        Rep2PhoneApplication.setUserPerferedLunchGroup(LunchGroupsFractivityFragment.this.getActivity(), key);
        String userKey = Rep2PhoneApplication.getUserKey(getActivity());
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference uderRef = database.getReference(Rep2PhoneApplication.getUserKey(getActivity()));
        uderRef.child(User.getDisplayNameLink()).setValue(user.getDisplayName());
        Rep2PhoneApplication.updateDeviceToken(getActivity(), true);
