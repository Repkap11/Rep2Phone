...
public class UpdateAppTask extends AsyncTask<Void, Void, Integer> {
    ...
    protected Integer doInBackground(Void... arg0) {
        ...
        try {
            ...
            c.connect();
            outputFile = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "Rep2Phone.apk");
...

        {
            ...
            e.printStackTrace();
            return R.string.update_app_task_error_updating_rep2phone;
