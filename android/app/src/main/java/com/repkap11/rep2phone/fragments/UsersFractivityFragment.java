...
import com.repkap11.rep2phone.activities.EditUserFractivity;
import com.repkap11.rep2phone.activities.base.FirebaseKeyLookupAdapterFractivity;
...
public class UsersFractivityFragment extends FirebaseKeyLookupAdapterFractivity.FirebaseKeyLookupAdapterFragment<UsersFractivityFragment.Holder, User> {
    ...
    public static final String STARTING_INTENT_WHICH_USERS_SUB_GROUP = "com.repkap11.rep2phone.STARTING_INTENT_WHICH_USERS_SUB_GROUP";
    public static final String STARTING_INTENT_WHICH_USERS_GROUP = "com.repkap11.rep2phone.STARTING_INTENT_WHICH_USERS_GROUP";
    public static final String STARTING_INTENT_TITLE = "com.repkap11.rep2phone.STARTING_INTENT_TITLE";
    ...
    protected void create(Bundle savedInstanceState) {
        ...
        //mLunchGroup = Rep2PhoneApplication.getUserPerferedLunchGroup(getActivity());
    ...
    protected View createAdapterView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState, boolean attachToRoot) {
        ...
        final String userLink = database.getReference(Rep2PhoneApplication.getUserKey(getActivity())).getKey();
        ...
        mIllDriveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String userLink = database.getReference(Rep2PhoneApplication.getUserKey(getActivity())).getKey();
